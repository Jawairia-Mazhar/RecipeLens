...
const SearchBar = ({onSearch, initialValue = '', className = ''}) => {
  ...
  return (
    <div className={`searchContainer placeholder:text-gray-400 focus-within:placeholder:text-gray-200 place-items-center gap-2 border-6 border-transparent bg-white/50 backdrop-blur-xs bg-clip-padding rounded-3xl p-2 w-full max-w-md flex items-center ${className}`}>
